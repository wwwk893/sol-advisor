...
Sol. It is not part of native mixed-model V2 and never adds another `agent_type`. Native V2 keeps
exactly `deep_explorer`, `explorer`, `worker`, `tester`, and `reviewer`.
