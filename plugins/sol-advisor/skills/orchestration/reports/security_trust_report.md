...
Scope: `skills/orchestration` only. This Yao report is not package-wide shell trust evidence;
see [`reports/plugin_shell_trust.md/.json`](plugin_shell_trust.md) for the machine-checked inventory
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| scripts/evaluate_coordination.py | cli | False | True | True | False | False | False | False | Default CLI classification; add SCRIPT_INTERFACE for internal modules. |
