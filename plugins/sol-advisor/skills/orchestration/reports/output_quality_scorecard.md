# Output quality scorecard — Sol Advisor 0.7.1
...
| Gate | 0.6.8 baseline | 0.7.1 candidate | Evidence |
| --- | --- | --- | --- |
...
The 87 fixture transitions and 59 adversarial mutations are `computed_state_transition_evidence`;
the evaluator derives decisions from state and action, including whole worker packets, final-candidate
tester/reviewer admission, safety-before-latency ordering, same-child corrections, repeat suppression, ownership gates, fixed explorer-only evidence-role admission,
